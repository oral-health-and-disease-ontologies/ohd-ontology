...
WHERE { 
  ?materialtype rdfs:subClassOf obo:OHD_0000000 . # obo:OHD_0000000 -> 'restoration material'
  ?materiali rdf:type ?materialtype .
  #?materiali obo:OHD_0000092 ?materialtype . # obo:OHD_0000092 -> 'asserted type'
  ?procedurei rdf:type obo:OHD_0000002 . # obo:OHD_0000002 -> 'dental procedure'
  ...
  ?materialtype rdfs:label ?material . 
FILTER (?materialtype != obo:OHD_0000000) # obo:OHD_0000000 -> 'restoration material'
