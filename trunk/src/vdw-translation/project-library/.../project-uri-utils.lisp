...
(defun vdw-uri-base-string ()
  "http://purl.obolibrary.org/obo/OHDVDW_")

(defun vdw-ontlogy-iri-string ()
   "http://purl.obolibrary.org/obo/ohd-vdw.owl")
...
(defun instance-axiom (instance class)
...
(defun make-instance-uri (string &key (salt *vdw-salt*) class-type uri-base args)
  "Returns a unique uri for instances in the ontology by doing a md5 checksum on the string parameter. 
