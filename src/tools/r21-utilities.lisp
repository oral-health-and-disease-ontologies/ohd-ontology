...
(defun get-eaglesoft-dental-exam-iri (patient-id occurrence-date provider-id)
  ...
  (let ((uri nil))
    ...
    (setf uri (get-unique-individual-iri patient-id
					    ...
					    :args `(,occurrence-date ,provider-id "dental exam" "eaglesoft")))
    ;; return uri
    uri))
