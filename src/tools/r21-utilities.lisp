...
(defun get-eaglesoft-dental-visit-iri (patient-id occurrence-date)
  "Returns a uri for a dental visit that is generated by the patient id and the date of the visit."
  (let ((uri nil))
    (setf uri 
	  (get-unique-individual-iri patient-id 
				     :salt *eaglesoft-salt*
...
;; note: I have not yet implempleted visits in an owl file. However, for convenience, 
;; I will define an iri base for visits.  This may come in handy later
