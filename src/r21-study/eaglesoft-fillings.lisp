...
(defun get-eaglesoft-filling-axioms (patient-id occurrence-date tooth-data 
  ...
  (let ((axioms nil)
    ...
    (loop for tooth in teeth-list do
	 ...
	 (setf ohd-material-uri (get-filling-material-type-uri ada-code))
	 ...
	 (setf material-name (get-filling-material-name ada-code))
	 (push `(annotation-assertion !rdfs:label 
				      ,material-uri
...
(defun get-filling-material-name (ada-code)
...
(defun get-filling-material-type-uri (ada-code)
  ...
  (let ((material-uri nil))
    ...
    (cond
      ...
      ((member ada-code *gold-code-list* :test 'equalp)
       (setf material-uri !'gold foil dental restoration material'@ohd))
      (t
...
(defun get-eaglesoft-filling-restoration-name (ada-code)
  ...
  (let ((restoration-name nil))
    ...
    (cond
      ...
      (t
       (setf restoration-name "intracoronal")))
...
(defun get-eaglesoft-filling-restoration-uri (ada-code)
  ...
  (let ((restoration-uri nil))
    ...
    (cond
      ((member ada-code *amalgam-code-list* :test 'equalp) 
       (setf restoration-uri !'amalgam restoration procedure'@ohd))
      ((member ada-code *resin-code-list* :test 'equalp)  
       (setf restoration-uri !'resin restoration procedure'@ohd))
      ((member ada-code *gold-code-list* :test 'equalp)
       (setf restoration-uri !'gold foil restoration procedure'@ohd))
      (t
