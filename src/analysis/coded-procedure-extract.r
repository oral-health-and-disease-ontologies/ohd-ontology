...
## See below for expanded SPARQL query and original extract request

coded_procedure_extract <- function(limit=1000,file="~/report.csv") 
  ## Create a csv file with 4 columns: patient identifier, date of
  ## procedure, code for procedure, tooth identifier

  ## Patient identifier is a string (anonymized)
  ## Date is in the form YYYY-MM-DD
  ## Procedure code is an CDT Dnnnn code.
  ## Tooth identifier is a string of the form "Tooth N" where N is the
  ##    ADA Universal tooth number
...
## The below should be updated if the query changes.
